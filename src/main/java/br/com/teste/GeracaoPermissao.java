...
import br.com.teste.dao.controleacesso.PermissaoDAO;
...
public class GeracaoPermissao {
    ...
    public void generate() {
        ...
        //Aluno
        create(new Permissao("aluno", "Aluno", true), null);
        create(new Permissao("aluno.create", "Cadastro de Aluno", "/view/escola/aluno/createAluno.jsf", true), "aluno");
        create(new Permissao("aluno.list", "Consulta de Aluno", "/view/escola/aluno/listAluno.jsf", true), "aluno");
